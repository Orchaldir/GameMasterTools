...
class LanguageTest {
    ...
    inner class UpdateTest {
        ...
        fun `Cannot update unknown id`() {
            val action = UpdateAction(Language(LANGUAGE_ID_1))
        ...
        fun `Inventor must exist`() {
            ...
            val action = UpdateAction(Language(LANGUAGE_ID_0, date = DAY0, origin = origin))
        ...
        fun `Parent language must exist`() {
            ...
            val action = UpdateAction(Language(LANGUAGE_ID_0, origin = origin))
        ...
        fun `A language cannot be its own parent`() {
            val action = UpdateAction(Language(LANGUAGE_ID_0, origin = EvolvedElement(LANGUAGE_ID_0)))
        ...
        fun `Date is in the future`() {
            ...
            val action = UpdateAction(Language(LANGUAGE_ID_0, date = FUTURE_DAY_0, origin = origin))
        ...
        fun `Parent language exist`() {
            ...
            val action = UpdateAction(language)
