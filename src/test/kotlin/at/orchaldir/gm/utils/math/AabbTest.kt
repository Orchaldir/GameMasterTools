...
class AabbTest {
    ...
    private val center = Point2d.fromMeters(17, 33)
    ...
    fun `Mirror a polygon vertically`() {
        val polygon = Polygon2d(List(3) { Point2d.fromMeters(9.0f, 18.0f) })
        val mirrored = Polygon2d(List(3) { Point2d.fromMeters(25.0f, 18.0f) })
    ...
    @Test
    fun `Move an AABB`() {
        val result = aabb + Point2d.fromMeters(10.0f, 20.0f)
        val expected = AABB(Point2d.fromMeters(12.0f, 23.0f), size)
