...
public class BasicSpeedCalculatorTest {
	...
	private CharacterTemplate template1 = new CharacterTemplateBuilder("test2").setAttributes(1, 2, 3, 4).createCharacterTemplate();
	private CharacterTemplate template2 = new CharacterTemplateBuilder("test3").setBasicSpeedModifier(-1).createCharacterTemplate();
	private CharacterTemplate template3 = new CharacterTemplateBuilder("test4").setDexterity(-1).setHealth(2).setBasicSpeedModifier(2).createCharacterTemplate();
