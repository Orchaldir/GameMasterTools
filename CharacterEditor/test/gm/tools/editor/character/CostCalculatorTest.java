...
public class CostCalculatorTest {
	...
	private CharacterTemplate template2 = new CharacterTemplateBuilder("test2").setStrength(11).setBasicSpeedModifier(-3).createCharacterTemplate();
	...
	public void calculateCostOfSecondaryCharacteristics() {
		...
		assertEquals(-15, costCalculator.calculateCostOfSecondaryCharacteristics(template2));
	}
	...
	public void calculateCharacterPoints() {
		...
		assertEquals(-5, costCalculator.calculate(template2));
	}
}